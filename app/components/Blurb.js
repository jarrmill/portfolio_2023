...
export default function Blurb() {
  return (
    <div className={styles.blurb_container}>
      <p className={styles.blurb_paragraph}>In 2011, students were just being able to afford personal computers. I started tinkering around with a language called Python in my spare time. I fell in love with coding, and since then I've had the pleasure of building <b>stunning features</b> for web applications, and a <b>clean, versatile component library.</b></p>
